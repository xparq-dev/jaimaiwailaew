> สถานะปัจจุบัน: Phase 1A merge แล้ว และชุดกฎปี 2568/2569 เวอร์ชัน `1.0.0`
> ผ่าน validation/review ใน repository ก่อนเผยแพร่เป็น `verified / published` สำหรับการประมาณการ
...
- `src/tax/rules/2568/` และ `src/tax/rules/2569/` (ชุดกฎที่เผยแพร่เป็นเวอร์ชัน `1.0.0`)
...
- ชุดกฎที่ไม่ผ่าน review/validation ยังคง fail closed; ชุดกฎปี 2568/2569 ปัจจุบันเป็น
  `status: published`, `validationStatus: valid` และ `notForCalculation: false`
- ผลลัพธ์เป็นค่าประมาณการเพื่อเตรียมข้อมูล ไม่ใช่แบบยื่นภาษีหรือคำรับรองทางกฎหมาย
