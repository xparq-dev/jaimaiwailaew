...
9. **Local-only PDF Export:** รายงาน A4 ถูกสร้างเมื่อผู้ใช้กดปุ่มเท่านั้น โดยตัวสร้าง PDF ฝั่งเบราว์เซอร์อ่าน workspace ใน memory และดาวน์โหลดไฟล์ลงอุปกรณ์โดยตรง
